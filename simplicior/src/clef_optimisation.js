...
import { segmentTypeMap } from "./src/segment.js";
import { log } from "./src/helpers.js";
import { gClefsToMiddlePitches, middlePitchesToClefs} from "./src/clef.js";
        ...
        while (measure) {
            ...
            if (newClef !== currentClef) {
                ...
                if (!clef_present) {
                    ...
                    var clefElement = curScore.createElement(Element.CLEF);
                    clefElement.clefType = newClef;
